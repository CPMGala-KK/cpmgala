...
__CHANNEL_USERNAME__ = "CPMRamm"
__GROUP_USERNAME__   = "CPMRammchat"
...
def banner(console):
    ...
    brand_name = figlet_format('CPMRamm', font='bloody')
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @ram_cq ')) 
